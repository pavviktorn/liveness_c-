...
from .cropface import get_align5p, align_5p, get_cropped, get_parts
    ...
    if label and isinstance(sourceRgb, np.ndarray):
        ...
        if sel >= 0.5:
            ...
            if sel < 0.65:
                ...
                res = get_parts(targetRgb, face_bbox, landmark)
                for idx in range(len(res)):
                    mfs_result.append(res[idx])
